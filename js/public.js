...
$(function () {
  $("body > #main_header #top .lang, body > #main_header nav div").hover (function(){
    $(this).addClass ('a');
  }, function(){
    $(this).removeClass ('a');
  })
  ...
  $(window).resize (function () {
    // if ()
    $('html #main_header > div nav > div .list').css ({'max-height': $(window).height () - ($(window).width () < 960 ? 220 : 200)});
