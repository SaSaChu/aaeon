...
$(function () {
  var oldIE;
    ...
    if (oldIE) {
      if (confirm ('此網站建議使用ie9以上版本瀏覽'))
        window.location.assign ('https://www.microsoft.com/en-us/download/internet-explorer.aspx');
      else
        window.location.assign ('http://webie.aaeon.com.tw/tw/');
    }

  $("body > header #top .lang, body > header nav div").hover (function(){
    $(this).addClass ('a');
  }, function(){
    $(this).removeClass ('a');
  })
